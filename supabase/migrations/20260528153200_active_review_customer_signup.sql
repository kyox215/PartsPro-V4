-- New Google/password customer shells should be visible to staff as "needs review"
-- while still allowing price visibility. Checkout remains blocked until the
-- personal-center profile is completed.
