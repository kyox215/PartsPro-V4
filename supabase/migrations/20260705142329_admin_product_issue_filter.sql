...
drop function if exists public.admin_list_products(integer, integer, text, text, text, text, text, text, text, text, text, text, text, text, boolean, text);
...
drop function if exists private.admin_list_products(integer, integer, text, text, text, text, text, text, text, text, text, text, text, text, boolean, text);
...
begin
  ...
  filtered_products as (
    ...
    left join sold_summary as sold on sold.sku_code = p.sku_code
  ...
  summary as (
    select
      ...
      count(*) filter (where status = 'active' and stock_status = 'Low Stock') as active_low_stock,
      count(*) filter (where status = 'active' and stock_status = 'Out of Stock') as active_out_of_stock,
