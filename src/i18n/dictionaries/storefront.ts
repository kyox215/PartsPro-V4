...
export const storefrontItIT = {
  ...
  "storefront.rma.upload.resumeHint": "Lo stato del caricamento è conservato. Ritenta l'invio oppure ricomincia per cancellare i dati temporanei.",
...
export const storefrontZhCN = {
  ...
  "storefront.rma.upload.resumeHint": "上传状态已保留。可以重试提交，或重新开始并清理临时数据。",
