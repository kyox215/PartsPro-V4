...
const rmaReasonKeys: Record<string, string> = {
  ...
  shipping_damage: "shippingDamageReason",
  not_as_described: "notAsDescribed",
  wrong_item: "wrongItemReason",
...
export function rmaCustomerStageLabel(t: StorefrontTranslator, value: string) {
  const key = rmaCustomerStageKeys[value];

  return key ? tx(t, `storefront.rma.stage.${key}`, value) : value;
}
...
export const storefrontItIT = {
  ...
  "storefront.common.unitEach": "pz",
  "storefront.price.discountEach": "-{amount} / pz",
  ...
  "storefront.cart.detailsBasePrice": "Prezzo listino",
  "storefront.cart.detailsCompatibility": "Modelli compatibili",
  "storefront.cart.detailsImageHint": "Tocca l'immagine per ingrandire.",
  "storefront.cart.detailsImageZoomAria": "Ingrandisci immagine per {name}",
  "storefront.cart.detailsImageZoomTitle": "Ingrandisci immagine",
  "storefront.cart.detailsLeadTime": "Consegna",
  "storefront.cart.detailsLineTotal": "Totale riga",
  "storefront.cart.detailsMoq": "MOQ",
  "storefront.cart.detailsNoImage": "Nessuna immagine",
  "storefront.cart.detailsNoImageHint": "Il prodotto usa il segnaposto categoria.",
  "storefront.cart.detailsOpenAria": "Apri dettagli prodotto per {name}",
  "storefront.cart.detailsOpenTitle": "Vedi dettagli prodotto",
  "storefront.cart.detailsQuantity": "Quantità",
  "storefront.cart.detailsRma": "Assistenza",
  "storefront.cart.detailsRmaDays": "{days} giorni",
  "storefront.cart.detailsStatus": "Stato",
  "storefront.cart.detailsStock": "Stock",
  "storefront.cart.detailsTags": "Tag prodotto",
  "storefront.cart.detailsTitle": "Dettaglio prodotto",
  "storefront.cart.detailsUnitPrice": "Prezzo unitario",
  "storefront.cart.detailsWarehouse": "Magazzino",
  ...
  "storefront.cart.priceEach": "{price} / pz",
  ...
  "storefront.product.detail.afterSales": "Assistenza",
  "storefront.product.detail.afterSalesDays": "{days} giorni",
  ...
  "storefront.product.purchase.quoteEstimatedTotal": "Totale stimato",
  "storefront.product.purchase.quoteLocalNote":
    "Preventivo locale: lo stock viene controllato lato interfaccia prima dell'invio.",
  "storefront.product.purchase.quotePriceEach": "Prezzo IVA inclusa",
  "storefront.product.purchase.quoteQuantity": "Quantita",
  "storefront.product.purchase.quoteSubtotal": "Subtotale prodotti",
  "storefront.product.purchase.quoteTitle": "Riepilogo preventivo",
  ...
  "storefront.header.searchLoading": "Ricerca in corso...",
  "storefront.header.searchSubmit": "Cerca",
  "storefront.logo.tagline": "Ricambi smartphone per clienti professionali",
  "storefront.navigation.loadingCatalog": "Caricamento catalogo...",
  "storefront.navigation.loadingProduct": "Caricamento prodotto...",
  ...
  "storefront.home.hero.description":
    "PartsPro unisce catalogo professionale, disponibilità locale, prezzi riservati, fatturazione elettronica e assistenza tracciabile in un unico flusso per il mercato italiano.",
  ...
  "storefront.home.hot.title": "Prodotti più richiesti",
  "storefront.home.new.empty":
    "Non ci sono nuovi prodotti da mostrare in questo momento.",
  "storefront.home.new.eyebrow": "Arrivi catalogo",
  "storefront.home.new.title": "Nuovi prodotti",
  "storefront.home.remax.empty": "I preordini REMAX saranno disponibili a breve.",
  "storefront.home.remax.eyebrow": "Esclusiva PartsPro",
  "storefront.home.remax.title": "REMAX · Prenota i prossimi arrivi",
  "storefront.home.notifications": "Notifiche",
  "storefront.home.mobileMenuDescription": "Menu mobile con home e catalogo.",
  ...
  "storefront.home.products.title": "Disponibili ora",
  "storefront.home.rightRail.account.subtitle": "Profilo, ordini e assistenza",
  ...
  "storefront.home.trust.support.title": "Assistenza tracciabile",
  ...
  "storefront.home.workflow.afterSales.title": "Gestisci assistenza e documenti",
  ...
  "storefront.preorder.available": "prenotabili",
  "storefront.preorder.badge": "Preordine",
  "storefront.preorder.eta": "Arrivo previsto",
  "storefront.preorder.etaBadge": "Preordine · ETA {eta}",
  "storefront.preorder.reserve": "Prenota",
  "storefront.preorder.reserveNow": "Prenota ora",
  "storefront.preorder.summaryTitle": "Riepilogo preordine",
  ...
  "storefront.rma.badge": "Assistenza tracciabile",
  "storefront.rma.description":
    "Collega la richiesta a un ordine, scegli il motivo e allega le foto necessarie per velocizzare la verifica.",
  "storefront.rma.block.order.title": "Ordine e prodotto acquistato",
  "storefront.rma.block.order.helper": "Partiamo da una riga ordine reale: niente numeri d'ordine o SKU da digitare.",
  "storefront.rma.block.reason.title": "Motivo e soluzione desiderata",
  "storefront.rma.block.reason.helper": "Per le richieste B2B è necessaria almeno una foto. La decisione finale resta al team PartsPro.",
  "storefront.rma.block.images.title": "Foto per il dossier",
  "storefront.rma.block.images.helper": "Aggiungi immagini nitide del prodotto, dell'imballo o dell'etichetta.",
  "storefront.rma.order.choose": "Scegli un ordine",
  "storefront.rma.order.change": "Cambia ordine",
  "storefront.rma.order.chooseLine": "Scegli il ricambio",
  "storefront.rma.order.singleLine": "Riga selezionata automaticamente",
  "storefront.rma.order.lineAvailable": "Disponibili {count}",
  "storefront.rma.order.linePurchased": "acquistati {count}",
  "storefront.rma.order.lineRequested": "già richiesti {count}",
  "storefront.rma.order.none": "Nessun ordine spedito o consegnato con quantità disponibile.",
  "storefront.rma.order.loading": "Caricamento ordini...",
  "storefront.rma.reason.label": "Motivo del reso",
  "storefront.rma.reason.qualityDefect": "Difetto di qualità o funzionamento",
  "storefront.rma.reason.shippingDamage": "Danno da trasporto",
  "storefront.rma.reason.notAsDescribed": "Non conforme alla descrizione",
  "storefront.rma.reason.wrongItem": "Articolo errato",
  "storefront.rma.reason.missingOrQuantityError": "Articolo o quantità mancanti",
  "storefront.rma.reason.withdrawalNoLongerNeeded": "Non più necessario",
  "storefront.rma.resolution.label": "Come preferisci risolvere",
  "storefront.rma.resolution.replacement": "Sostituzione",
  "storefront.rma.resolution.walletCredit": "Rimborso nel saldo PartsPro",
  "storefront.rma.resolution.walletHint": "Il rimborso viene accreditato nel saldo PartsPro dopo la verifica.",
  "storefront.rma.note.label": "Nota aggiuntiva (opzionale)",
  "storefront.rma.note.add": "Aggiungi una nota (opzionale)",
  "storefront.rma.note.required": "Aggiungi una breve spiegazione per questo motivo.",
  "storefront.rma.note.placeholder": "Aggiungi un breve dettaglio utile al team...",
  "storefront.rma.note.withdrawalHint": "Puoi aggiungere una breve spiegazione, senza inserire dati di pagamento.",
  "storefront.rma.upload.resumeHint": "Lo stato del caricamento è conservato. Ritenta l'invio oppure ricomincia: abbandonerai il recupero locale e verranno puliti i dati temporanei.",
  "storefront.rma.upload.confirmSubmit": "Conferma invio",
  "storefront.rma.upload.abandonHint": "La richiesta potrebbe essere già stata registrata: conferma l'invio per riprovare in sicurezza. Ricominciare abbandona il recupero e avvia la pulizia.",
  "storefront.rma.upload.cleanupHint": "La pulizia precedente deve terminare. Il vecchio invio non verrà ripetuto.",
  "storefront.rma.upload.abandonRestart": "Abbandona recupero e ricomincia",
  "storefront.rma.upload.continueCleanup": "Continua pulizia",
  "storefront.rma.upload.restarting": "Pulizia dello stato di caricamento...",
  "storefront.rma.upload.restartingShort": "Pulizia...",
  "storefront.rma.upload.restart": "Ricomincia upload",
  "storefront.rma.upload.restartError": "Impossibile pulire lo stato del caricamento. Riprova.",
  "storefront.rma.image.camera": "Scatta foto",
  "storefront.rma.image.gallery": "Scegli dalla galleria",
  "storefront.rma.image.hint": "Massimo 6 foto, 4 MB ciascuna. Formati: JPG, PNG, WebP, HEIC o HEIF.",
  "storefront.rma.image.required": "Aggiungi almeno una foto per inviare la richiesta.",
  "storefront.rma.image.selected": "{count} foto pronte per il caricamento.",
  "storefront.rma.image.limit": "Puoi aggiungere al massimo 6 foto.",
  "storefront.rma.image.invalid": "Questo file non è un'immagine supportata.",
  "storefront.rma.image.duplicate": "Questa foto è già stata aggiunta.",
  "storefront.rma.image.title": "Foto della richiesta",
  "storefront.rma.image.tooLarge": "Questa foto supera il limite di 4 MB e non può essere compressa.",
  "storefront.rma.image.remove": "Rimuovi foto {name}",
  "storefront.rma.image.preparing": "Preparazione foto {current}/{total}...",
  "storefront.rma.image.uploading": "Caricamento foto {current}/{total}...",
  "storefront.rma.image.verifying": "Verifica foto {current}/{total}...",
  "storefront.rma.image.preparingShort": "Preparazione...",
  "storefront.rma.image.uploadingShort": "Caricamento...",
  "storefront.rma.image.verifyingShort": "Verifica...",
  ...
  "storefront.rma.stage.completed": "Completata",
  "storefront.rma.shipped.button": "Ho spedito il reso",
  "storefront.rma.shipped.loading": "Registrazione...",
  "storefront.rma.shipped.success": "Reso segnato come spedito.",
  "storefront.rma.shipped.error": "Non è stato possibile registrare la spedizione. Riprova.",
  "storefront.rma.shipped.details": "Aggiungi dati di spedizione (opzionale)",
  "storefront.rma.shipped.carrier": "Corriere (opzionale)",
  "storefront.rma.shipped.tracking": "Tracking (opzionale)",
  "storefront.rma.shipped.time": "Spedito il {date}",
  "storefront.rma.shipped.hint": "Corriere e tracking non sono necessari: puoi confermare con un tocco.",
  "storefront.rma.submit.selectOrderLine": "Scegli prima un ordine e un ricambio.",
  "storefront.rma.submit.noImages": "Aggiungi almeno una foto prima di inviare.",
  "storefront.rma.submit.preparing": "Preparazione della richiesta...",
  "storefront.rma.submit.draft": "Apertura della richiesta...",
  "storefront.rma.submit.finalizing": "Invio della richiesta...",
  "storefront.rma.submit.retry": "Riprovo il caricamento della foto...",
  "storefront.rma.submit.successNext": "Conserva questo numero: il team aggiornerà qui i prossimi passaggi.",
  "storefront.rma.submit.photoFailure": "Una foto non è stata caricata. L'anteprima è ancora disponibile: correggi il file e riprova.",
  ...
  "storefront.rma.form.evidence": "Aggiungi foto del problema",
  "storefront.rma.form.evidenceEmpty":
    "Nessuna foto selezionata. Per questa richiesta commerciale serve almeno una foto.",
  "storefront.rma.form.evidenceHint":
    "JPG, PNG, WebP, HEIC o HEIF; massimo 6 foto, 4MB ciascuna.",
  ...
  "storefront.rma.form.reason": "Motivo assistenza",
  "storefront.rma.form.title": "Nuova richiesta assistenza",
  "storefront.rma.recent.empty": "Nessuna richiesta assistenza registrata.",
  "storefront.rma.recent.title": "Richieste recenti",
  "storefront.rma.result.number": "Numero richiesta assistenza",
  ...
  "storefront.rma.rules.title": "Regole assistenza",
  "storefront.rma.submit.button": "Invia richiesta assistenza",
  ...
  "storefront.rma.submit.loading": "Invio richiesta assistenza in corso...",
...
export const storefrontZhCN = {
  ...
  "storefront.price.discountEach": "每件减 {amount}",
  ...
  "storefront.cart.detailsBasePrice": "目录价",
  "storefront.cart.detailsCompatibility": "兼容型号",
  "storefront.cart.detailsImageHint": "点击图片可放大查看。",
  "storefront.cart.detailsImageZoomAria": "放大查看 {name} 的图片",
  "storefront.cart.detailsImageZoomTitle": "放大图片",
  "storefront.cart.detailsLeadTime": "交期",
  "storefront.cart.detailsLineTotal": "本行合计",
  "storefront.cart.detailsMoq": "MOQ",
  "storefront.cart.detailsNoImage": "暂无图片",
  "storefront.cart.detailsNoImageHint": "该商品使用分类占位图。",
  "storefront.cart.detailsOpenAria": "查看 {name} 的商品详情",
  "storefront.cart.detailsOpenTitle": "查看商品详情",
  "storefront.cart.detailsQuantity": "数量",
  "storefront.cart.detailsRma": "售后",
  "storefront.cart.detailsRmaDays": "{days} 天",
  "storefront.cart.detailsStatus": "状态",
  "storefront.cart.detailsStock": "库存",
  "storefront.cart.detailsTags": "商品标签",
  "storefront.cart.detailsTitle": "商品详情",
  "storefront.cart.detailsUnitPrice": "单价",
  "storefront.cart.detailsWarehouse": "仓库",
  ...
  "storefront.customer.assignment.assigned": "已启用",
  "storefront.customer.assignment.convertedToEmployee": "已转员工",
  "storefront.customer.assignment.needsReview": "待审核",
  "storefront.customer.level.bronze": "青铜 Bronze",
  "storefront.customer.level.diamond": "钻石 Diamond",
  "storefront.customer.level.emerald": "翡翠 Emerald",
  "storefront.customer.level.gold": "黄金 Gold",
  "storefront.customer.level.king": "王者 King",
  "storefront.customer.level.master": "大师 Master",
  "storefront.customer.level.silver": "白银 Silver",
  "storefront.customer.status.approved": "活跃",
  "storefront.customer.status.pending": "待处理",
  "storefront.customer.status.rejected": "已拒绝",
  "storefront.customer.status.suspended": "已暂停",
  "storefront.customer.type.retail": "零售价客户",
  ...
  "storefront.product.detail.afterSales": "售后",
  "storefront.product.detail.afterSalesDays": "{days} 天",
  ...
  "storefront.product.purchase.quoteEstimatedTotal": "预估合计",
  "storefront.product.purchase.quoteLocalNote":
    "本地预估：提交前会在页面中再次检查库存。",
  "storefront.product.purchase.quotePriceEach": "含增值税单价",
  "storefront.product.purchase.quoteQuantity": "数量",
  "storefront.product.purchase.quoteSubtotal": "商品小计",
  "storefront.product.purchase.quoteTitle": "报价预览",
  ...
  "storefront.header.searchLoading": "正在搜索...",
  "storefront.header.searchSubmit": "搜索",
  "storefront.logo.tagline": "意大利专业客户手机配件",
  "storefront.navigation.loadingCatalog": "正在加载目录...",
  "storefront.navigation.loadingProduct": "正在加载商品...",
  ...
  "storefront.home.hero.description":
    "PartsPro 将专业客户目录、本地库存、登录后专属价格、电子发票和可追踪售后申请统一到一个面向意大利市场的采购流程中。",
  ...
  "storefront.home.new.empty": "当前暂无新到商品。",
  "storefront.home.new.eyebrow": "目录上新",
  "storefront.home.new.title": "新到产品",
  "storefront.home.remax.empty": "REMAX 预购商品即将开放。",
  "storefront.home.remax.eyebrow": "PartsPro 专属",
  "storefront.home.remax.title": "REMAX · 预订即将到货商品",
  "storefront.home.notifications": "通知",
  "storefront.home.mobileMenuDescription": "移动菜单包含首页和目录。",
  ...
  "storefront.home.products.title": "现货推荐",
  "storefront.home.rightRail.account.subtitle": "资料、订单和售后申请",
  ...
  "storefront.home.trust.support.title": "可追踪售后申请",
  ...
  "storefront.home.workflow.afterSales.text": "在账户中追踪售后申请、发票和历史记录。",
  "storefront.home.workflow.afterSales.title": "管理售后申请与单据",
  ...
  "storefront.preorder.available": "可预订",
  "storefront.preorder.badge": "预购",
  "storefront.preorder.eta": "预计到货",
  "storefront.preorder.etaBadge": "预购 · 预计 {eta}",
  "storefront.preorder.reserve": "预订",
  "storefront.preorder.reserveNow": "立即预订",
  "storefront.preorder.summaryTitle": "预购摘要",
  "storefront.checkout.preorder.confirmTerms":
    "我已了解这是预购商品：当前尚未到货，预计日期可能变化，商品到货并分配数量后才会发货。",
  "storefront.checkout.preorder.paymentNotice":
    "这是 REMAX 预购订单：使用银行转账登记付款，不会使用钱包余额。",
  "storefront.checkout.preorder.received":
    "预购单 {id} 已收到。商品到货后我们会通知你。",
  ...
  "storefront.rma.badge": "可追踪售后申请",
  "storefront.rma.description":
    "将申请关联到真实订单行，选择原因，并上传照片以便留档和加快检查。",
  "storefront.rma.block.order.title": "已购订单与商品",
  "storefront.rma.block.order.helper": "从真实订单行开始，不需要手动填写订单号或 SKU。",
  "storefront.rma.block.reason.title": "退货原因与处理方式",
  "storefront.rma.block.reason.helper": "B2B 商业退货需要至少一张照片；最终处理由 PartsPro 团队审核。",
  "storefront.rma.block.images.title": "图片记录",
  "storefront.rma.block.images.helper": "上传商品、包装或标签的清晰照片，作为申请记录。",
  "storefront.rma.order.choose": "选择订单",
  "storefront.rma.order.change": "更换订单",
  "storefront.rma.order.chooseLine": "选择配件",
  "storefront.rma.order.singleLine": "已自动选择唯一可退商品",
  "storefront.rma.order.lineAvailable": "可退 {count} 件",
  "storefront.rma.order.linePurchased": "已购 {count} 件",
  "storefront.rma.order.lineRequested": "已申请 {count} 件",
  "storefront.rma.order.none": "没有可退的已发货或已送达订单商品。",
  "storefront.rma.order.loading": "正在加载订单...",
  "storefront.rma.reason.label": "退货原因",
  "storefront.rma.reason.qualityDefect": "质量或功能问题",
  "storefront.rma.reason.shippingDamage": "运输损坏",
  "storefront.rma.reason.notAsDescribed": "与描述不符",
  "storefront.rma.reason.wrongItem": "商品发错",
  "storefront.rma.reason.missingOrQuantityError": "商品或数量缺失",
  "storefront.rma.reason.withdrawalNoLongerNeeded": "不再需要",
  "storefront.rma.resolution.label": "希望如何处理",
  "storefront.rma.resolution.replacement": "换货",
  "storefront.rma.resolution.walletCredit": "退回 PartsPro 余额",
  "storefront.rma.resolution.walletHint": "检查通过后，退款会记入 PartsPro 余额；不代表自动原路退款。",
  "storefront.rma.note.label": "补充说明（可选）",
  "storefront.rma.note.add": "添加补充说明（可选）",
  "storefront.rma.note.required": "请为这个原因补充一条简短说明。",
  "storefront.rma.note.placeholder": "补充一条有助于团队处理的简短说明...",
  "storefront.rma.note.withdrawalHint": "可以补充简短原因，请勿填写支付信息。",
  "storefront.rma.upload.resumeHint": "上传状态已保留。可以重试提交；重新开始会放弃本地恢复并清理临时数据。",
  "storefront.rma.upload.confirmSubmit": "确认提交",
  "storefront.rma.upload.abandonHint": "申请可能已经登记：请确认提交以安全重试。重新开始会放弃恢复并启动清理。",
  "storefront.rma.upload.cleanupHint": "上一次清理尚未完成。不会重复提交旧申请。",
  "storefront.rma.upload.abandonRestart": "放弃恢复并重新开始",
  "storefront.rma.upload.continueCleanup": "继续清理",
  "storefront.rma.upload.restarting": "正在清理上传状态……",
  "storefront.rma.upload.restartingShort": "清理中……",
  "storefront.rma.upload.restart": "重新开始上传",
  "storefront.rma.upload.restartError": "无法清理上传状态，请重试。",
  "storefront.rma.image.camera": "拍照",
  "storefront.rma.image.gallery": "从相册选择",
  "storefront.rma.image.hint": "最多 6 张，每张 4 MB。支持 JPG、PNG、WebP、HEIC 或 HEIF。",
  "storefront.rma.image.required": "请至少添加一张照片后再提交申请。",
  "storefront.rma.image.selected": "已准备上传 {count} 张照片。",
  "storefront.rma.image.limit": "最多只能添加 6 张照片。",
  "storefront.rma.image.invalid": "该文件不是支持的图片格式。",
  "storefront.rma.image.duplicate": "这张照片已经添加过了。",
  "storefront.rma.image.title": "申请照片",
  "storefront.rma.image.tooLarge": "该照片超过 4 MB，且无法压缩。",
  "storefront.rma.image.remove": "删除照片 {name}",
  "storefront.rma.image.preparing": "正在准备照片 {current}/{total}...",
  "storefront.rma.image.uploading": "正在上传照片 {current}/{total}...",
  "storefront.rma.image.verifying": "正在验证照片 {current}/{total}...",
  "storefront.rma.image.preparingShort": "准备中...",
  "storefront.rma.image.uploadingShort": "上传中...",
  "storefront.rma.image.verifyingShort": "验证中...",
  ...
  "storefront.rma.stage.completed": "已完成",
  "storefront.rma.shipped.button": "我已寄回",
  "storefront.rma.shipped.loading": "正在登记...",
  "storefront.rma.shipped.success": "已记录寄回。",
  "storefront.rma.shipped.error": "登记寄回失败，请重试。",
  "storefront.rma.shipped.details": "添加物流信息（可选）",
  "storefront.rma.shipped.carrier": "承运商（可选）",
  "storefront.rma.shipped.tracking": "追踪号（可选）",
  "storefront.rma.shipped.time": "寄回时间：{date}",
  "storefront.rma.shipped.hint": "无需填写承运商或追踪号，一键即可确认寄回。",
  "storefront.rma.submit.selectOrderLine": "请先选择订单和商品。",
  "storefront.rma.submit.noImages": "请先添加至少一张照片。",
  "storefront.rma.submit.preparing": "正在准备申请...",
  "storefront.rma.submit.draft": "正在创建申请草稿...",
  "storefront.rma.submit.finalizing": "正在提交申请...",
  "storefront.rma.submit.retry": "正在重试上传照片...",
  "storefront.rma.submit.successNext": "请保存这个编号，团队会在这里更新后续进展。",
  "storefront.rma.submit.photoFailure": "有一张照片上传失败。预览仍然保留，请修正文件后重试。",
  "storefront.rma.form.description": "问题描述",
  "storefront.rma.form.descriptionPlaceholder":
    "填写已做测试、故障表现、设备型号和配件状态...",
  "storefront.rma.form.evidence": "上传问题照片",
  "storefront.rma.form.evidenceEmpty": "尚未选择照片。商业退货至少需要一张照片。",
  "storefront.rma.form.evidenceHint":
    "支持 JPG、PNG、WebP、HEIC 或 HEIF，最多 6 张，每张 4MB。",
  ...
  "storefront.rma.form.reason": "售后原因",
  "storefront.rma.form.title": "新建售后申请",
  "storefront.rma.recent.empty": "暂无售后申请。",
  "storefront.rma.recent.title": "最近申请",
  "storefront.rma.result.number": "售后申请编号",
  ...
  "storefront.rma.rules.title": "售后申请规则",
  "storefront.rma.submit.button": "提交售后申请",
  "storefront.rma.submit.buttonLoading": "正在提交售后申请...",
  "storefront.rma.submit.changed": "本地修改已保存。可再次提交以创建新的售后申请。",
  "storefront.rma.submit.error": "提交售后申请时发生错误。",
